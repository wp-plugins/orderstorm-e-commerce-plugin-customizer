...
This plugin allows customization of cascading style sheets for the OrderStorm eCommerce plugin to prevent changes from being overwritten in an update.

==Description==

Never lose the changes you make to your style sheets in an update of the OrderStorm e-Commerce plugin. The OrderStorm e-Commerce Plugin Customizer sets up a second folder called **orderstorm-wordpress-e-commerce-custom** that contains a duplicate set of .css files for your shopping cart. You no longer need to worry about creating a separate backup of your style sheets prior to an upgrade. By using the OrderStorm e-Commerce Plugin Customizer, its done for you.  After the Customizer is installed, make all changes to the OrderStorm e-Commerce .css files in the Custom folder instead of to the .css files in the main plugin.
...
4. Click the 'Choose File' button and find the OrderStorm WordPress eCommerce Customizer plugin .zip file. Click 'Choose' followed by the 'Install Now' button.  WordPress will now upload and install your plugin.
...
1. To change the look of your shopping cart categories and products, go to the Plugin page. Then go to OrderStorm e-Commerce Plugin Customizer, click on 'Edit'.
